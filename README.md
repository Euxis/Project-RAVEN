...
This usually happens when you're using Windows. The easiest fix is to open the file in vim, with `vim build.sh`, typing `:set fileformat=unix` and pressing Enter.

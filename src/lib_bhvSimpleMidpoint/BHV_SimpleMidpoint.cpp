...
BHV_SimpleMidpoint::BHV_SimpleMidpoint(IvPDomain gdomain) : IvPContactBehavior(gdomain)
{
...
bool BHV_SimpleMidpoint::setParam(string param, string param_val) 
{
...
bool BHV_SimpleMidpoint::handleConfigModTrailRange(double mod) 
{
  m_trail_range += mod;
...
bool BHV_SimpleMidpoint::handleConfigModTrailRangePct(double pct_100) 
{
  if(pct_100 <= 0)
    return(false);
...
double BHV_SimpleMidpoint::getRelevance()
{
...
double BHV_SimpleMidpoint::updateTrailDistance()
{
